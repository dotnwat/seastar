...
inline constexpr auto dh_level_key = std::string_view("dh_level");
inline constexpr auto x509_trust_key = std::string_view("x509_trust");
inline constexpr auto x509_crl_key = std::string_view("x509_crl");
inline constexpr auto x509_key_key = std::string_view("x509_key");
inline constexpr auto pkcs12_key = std::string_view("pkcs12");
inline constexpr auto system_trust = std::string_view("system_trust");
